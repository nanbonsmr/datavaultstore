          ...
          {items.length === 0 ? (
            ...
            <>
                  ...
                  {items.map((item) => (
                    <div key={item.variantId} className="flex gap-4 p-3 rounded-lg border border-border bg-card">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="font-heading font-semibold text-foreground text-sm mt-1">
                          {item.price.currencyCode === 'USD' ? '$' : item.price.currencyCode}{parseFloat(item.price.amount).toFixed(2)}
                        </p>
                      </div>
              ...
              <div className="flex-shrink-0 space-y-4 pt-4 border-t border-border">
                ...
                <Button onClick={handleCheckout} className="btn-gradient w-full gap-2" size="lg" disabled={items.length === 0 || isLoading || isSyncing}>
